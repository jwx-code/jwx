...
/*
  Stored Procedures mit Validierung für:
  - partner
  - budget_types
  - budgets
  - event_types
...
/* ============================
   Helper: Keine, wir nutzen lokale Prüfungen in jedem SP
   ============================ */
...
BEGIN
  ...
  -- Prüfen ob Event auf Partner referenziert (Vermeide verwaiste events)
...
BEGIN
  ...
  -- Prüfen ob Budgets existieren, die diesen Typ verwenden
  DECLARE cnt INT DEFAULT 0;
...
BEGIN
  ...
  -- Prüfen, ob budget_type existiert
...
BEGIN
  ...
  -- Prüfen ob Event oder budget_performance referenzieren
...
BEGIN
  ...
  -- Prüfen dass Ziel-Event existiert
  DECLARE cnt_event INT DEFAULT 0;
  ...
  -- Prüfen FK-Referenzen (falls übergeben)
...
CREATE PROCEDURE budget_performance_get(IN p_id INT)
BEGIN
